...
namespace FlatRedBall.SpecializedXnaControls.Input
{
    ...
    {
        Camera mCamera;
        MonoGameContentControl mControl;
        ...
        public CameraPanningLogic(MonoGameContentControl graphicsControl, SystemManagers managers, Cursor cursor, Keyboard keyboard)
        {
            mManagers = managers;
